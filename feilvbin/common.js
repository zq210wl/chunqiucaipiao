...
var BET_LIST = [
  ...
  { index: 14, multiple: 40, money: 72.0 },      // 每一把收益: 0.13       成本：259.2
  { index: 15, multiple: 56, money: 100.8 },      // 每一把收益: 0.37      成本：360.0
  { index: 16, multiple: 77, money: 138.6 },      // 每一把收益: 0.25      成本：498.6
  { index: 17, multiple: 106, money: 190.8 },      // 每一把收益: 0.15     成本：689.4
  { index: 18, multiple: 147, money: 264.6 },      // 每一把收益: 0.31     成本：954.0
  { index: 19, multiple: 202, money: 363.6 },      // 每一把收益: 0.31     成本：1317.6
  { index: 20, multiple: 280, money: 504.0 }      // 每一把收益: 0.32      成本：1821.6
];
